...
export const MobileSidebar = ({
  ...
  return (
    <div
      className={cn(
        "h-14 px-4 py-4 flex flex-row md:hidden items-center justify-between bg-neutral-950 w-full border-b border-neutral-800",
        className
      )}
      {...props}
    >
      <div className="flex items-center gap-2 z-20">
        ...
        <span className="text-white font-bold text-sm">Projects Lab</span>
      </div>
...
export const SidebarLink = ({
  ...
  return (
    <Link
      href={link.href}
      className={cn(
        "flex items-center gap-2 group/sidebar py-2 justify-start overflow-hidden",
        className
      )}
      {...props}
    >
